/****************************************************************************
 ...
 through w/Library/WebServer/Documents/jscommunicator-J/JSCommManager.jshich recipients can access the Corresponding Source.
 ****************************************************************************/
...
(function($) {
 ...
 $("#jsc-login").hide();
 $("#logout").show();
 $("#logout").click(JSCommUI.show_login);
 $("#dial-controls").show();
 $("#reg").show();
